...
<body>
    <section class="congratulations">
        <h1>POZDRAVLYASHKI Jenkins is working !!!</h1>
        <p>Your AWSS Elastic Beanstalk <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
